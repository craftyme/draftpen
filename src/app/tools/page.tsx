  ...
  const categories: ToolCategory[] = [
    {
      ...
      tools: [
        ...
        },
        {
          ...
          path: "/image-converter/jpg-to-png",
        },
        {
          name: "PDF to JPG",
          description: "Convert PDF documents to JPG images",
          path: "/image-converter/pdf-to-jpg",
        },
        {
          name: "PDF to PNG",
          description: "Convert PDF documents to PNG images",
          path: "/image-converter/pdf-to-png",
        },
        {
          name: "PNG to JPG",
          description: "Convert PNG images to JPG format",
          path: "/image-converter/png-to-jpg",
        },
        {
          name: "PNG to SVG",
          description: "Convert PNG images to scalable vector graphics",
          path: "/image-converter/png-to-svg",
        },
        {
          name: "SVG Converter",
          description: "Convert to and from SVG format",
          path: "/image-converter/svg-converter",
        },
        {
          name: "WebP to JPG",
          description: "Convert WebP images to JPG format",
          path: "/image-converter/webp-to-jpg",
        },
      ],
    },
    {
      ...
      tools: [
        {
          ...
          path: "/image-tools/bulk-image-resizer",
        },
        {
          name: "Collage Maker",
          description: "Create beautiful photo collages",
          path: "/image-tools/collage-maker",
        },
        {
          name: "Color Picker",
        ...
        },
        {
          ...
          path: "/image-tools/image-enlarger",
        },
        {
          name: "Image Resizer",
        ...
        {
          name: "Meme Generator",
          description: "Create custom memes with your images",
          path: "/image-tools/meme-generator",
        },
        {
          name: "Rotate Image",
    ...
    },
    {
      ...
      tools: [
        ...
        {
          name: "PDF to GIF",
          description: "Convert PDF pages to animated GIFs",
          path: "/pdf-tools/pdf-to-gif",
        },
        {
          name: "PNG to PDF",
      ...
      tools: [
        {
          ...
          path: "/ebook-tools/epub-to-mobi",
        },
        {
          name: "MOBI to EPUB",
          description: "Convert MOBI eBooks to EPUB format",
          path: "/ebook-tools/mobi-to-epub",
        },
        {
          name: "PDF to EPUB",
          description: "Convert PDF documents to EPUB eBooks",
          path: "/ebook-tools/pdf-to-epub",
        },
        {
          name: "PDF to MOBI",
          description: "Convert PDF documents to MOBI eBooks",
          path: "/ebook-tools/pdf-to-mobi",
        },
        {
          name: "AZW to EPUB",
          description: "Convert Amazon AZW eBooks to EPUB format",
          path: "/ebook-tools/azw-to-epub",
        },
        {
          name: "AZW to MOBI",
          description: "Convert Amazon AZW eBooks to MOBI format",
          path: "/ebook-tools/azw-to-mobi",
        },
        {
          name: "EPUB to PDF",
          description: "Convert EPUB eBooks to PDF documents",
          path: "/ebook-tools/epub-to-pdf",
        },
        {
          name: "MOBI to PDF",
          description: "Convert MOBI eBooks to PDF documents",
          path: "/ebook-tools/mobi-to-pdf",
        },
      ],
    },
    {
      ...
      tools: [
        {
          ...
          description: "Create Capterra review widgets",
          path: "/social-proof/capterra",
        },
        {
          name: "G2 Reviews",
          description: "Generate G2 review displays",
          path: "/social-proof/g2",
        },
        {
          name: "Testimonials",
          description: "Design custom testimonial displays",
          path: "/social-proof/testimonial",
        },
        {
          name: "Trustpilot",
          description: "Create Trustpilot review widgets",
          path: "/social-proof/trustpilot",
        },
      ],
    },
    {
      ...
      tools: [
        ...
        {
          name: "Code Snippets",
          description: "Generate code snippet images",
          path: "/code",
        },
        {
          name: "Essay Formatter",
          description: "Format essays for sharing",
          path: "/essay",
        },
        {
          name: "Carousel Creator",
          description: "Create image carousels for social media",
          path: "/carousel",
        },
      ],
    },
      ...
      <div className="py-12 px-4 max-w-7xl mx-auto">
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-muted-foreground font-light max-w-3xl mx-auto">
            Explore our complete collection of tools for creating, converting,
            and sharing beautiful visuals
          </p>
        </div>
              ...
              <div className="border-b pb-2">
                <Link href={category.path} className="group">
                  <h2 className="text-2xl font-medium tracking-tight inline-flex items-center">
                    {category.title}
                    <svg
                      className="ml-1 w-5 h-5 opacity-0 group-hover:opacity-70 transition-opacity"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                      <path
