...
export default function PdfToMobiPage() {
  ...
  const ControlPanel = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium">Convert PDF to MOBI</h3>
        <p className="text-sm text-muted-foreground mt-1">
          Convert your PDF documents to MOBI format for Kindle devices.
        </p>
      </div>
            ...
            <Card className="border-dashed border-2 bg-muted/50">
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-sm text-muted-foreground text-center max-w-md mb-4">
                  Drag and drop your PDF file here, or use the upload button in
                  the control panel.
                </p>
