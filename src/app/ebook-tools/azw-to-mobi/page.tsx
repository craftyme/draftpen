...
export default function AzwToMobiPage() {
  ...
  const ControlPanel = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium">Convert AZW to MOBI</h3>
        <p className="text-sm text-muted-foreground mt-1">
          Convert your Amazon Kindle AZW eBooks to MOBI format for better
