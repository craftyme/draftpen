...
export default function JpgToPdfPage() {
  ...
  const ControlPanel = () => (
    <div className="space-y-4">
      <div>
        <h3 className="text-sm font-medium mb-2">Upload JPG Images</h3>
        <div className="flex flex-col gap-2">
          ...
          {files.length > 0 && (
            <p className="text-xs text-muted-foreground">
              Selected: {files.length} JPG image{files.length !== 1 ? 's' : ''}
            </p>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button variant="outline" size="sm">Landscape</Button>
        </div>
      </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center min-h-[300px] text-center">
            {files.length > 0 ? (
              ...
              <div>
                <h3 className="text-lg font-medium mb-2">JPG to PDF</h3>
                <p className="text-sm text-muted-foreground">
                  Convert your JPG images to PDF format with customizable quality settings.
                </p>
              </div>
            )}
          </div>
