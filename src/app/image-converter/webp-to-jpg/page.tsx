...
export default function WebpToJpgPage() {
  ...
  const ControlPanel = () => (
    <div className="space-y-4">
      <div>
        <h3 className="text-sm font-medium mb-2">Upload WebP Files</h3>
      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center min-h-[300px] text-center">
            {files.length > 0 ? (
              <div>
                <p className="font-medium">{files.length} WebP image{files.length !== 1 ? 's' : ''} selected</p>
              ...
              <div>
                <h3 className="text-lg font-medium mb-2">WebP to JPG</h3>
                <p className="text-sm text-muted-foreground">
                  Convert Google&apos;s WebP format to widely compatible JPG images. Perfect for better compatibility with various applications.
                </p>
              </div>
            )}
          </div>
