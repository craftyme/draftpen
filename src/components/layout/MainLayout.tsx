    ...
    <div className="flex flex-col h-screen">
      {announcementConfig.enabled && (
        <AnnouncementBanner
          ...
          icon={
            announcementConfig.icon && <announcementConfig.icon size={16} />
          }
        ...
        <Link href="/" className="flex items-center gap-1">
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M20 0C31.0457 0 40 8.9543 40 20C40 31.0457 31.0457 40 20 40C8.9543 40 0 31.0457 0 20C0 8.9543 8.9543 0 20 0ZM35 20C35 28.2843 28.2843 35 20 35V5C28.2843 5 35 11.7157 35 20Z"
              fill="#0071e3"
            />
          </svg>
          ...
          <TabsList className="h-9 bg-transparent p-1 rounded-lg">
            ...
            >
              <Link href="/image-converter" className="icon-nav">
                <ImageIcon
                  className="h-4 w-4"
                  aria-label="Image Converter icon"
                />
            ...
            <TabsTrigger
              ...
              className="h-7 rounded transition-all"
            >
              <Link href="/ebook-tools" className="icon-nav">
                <BookOpen className="h-4 w-4" aria-label="eBook Tools icon" />
                <span className="text-xs font-normal">eBook Tools</span>
              </Link>
            </TabsTrigger>
          </TabsList>
        </Tabs>
      ...
      <footer className="py-2 px-4 border-t flex items-center justify-between flex-wrap gap-2 text-xs text-[#86868b] dark:text-gray-400 font-light shrink-0">
        <div>
          {new Date().getFullYear()} &copy; Draftpen - Craft beautiful shareable
          visuals from your content. Standing on the shoulders of giants.
        </div>
